import unittest
import fsa.param_wfsa as fsa
from fsa.arc_set import ArcSet
...
class TestParamFSA( unittest.TestCase ):
    def setUp(self):
        ...
        self.fsa1 = fsa.ParametrizedWFSA('abcd', '$', self.stateset1,
                self.parameter1)
        ...
        self.fsa2 = fsa.ParametrizedWFSA('abcd', '$', self.stateset2,
                self.parameter2)
